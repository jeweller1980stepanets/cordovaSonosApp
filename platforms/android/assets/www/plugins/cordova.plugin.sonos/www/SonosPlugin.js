                                    ...
                                    console.log('readyState' + xmlhttp.readyState);
                                        ...
                                        if (xmlhttp.status == 200) {
                                           ...
                                           console.log(xmlhttp.responseText);
                                            ...
                                            alert('Все huevo, status' + xmlhttp.status);
...
xmlhttp.open("POST", "http://"+ip+":1400/MediaRenderer/RenderingControl/Control", true);
                xmlhttp.onreadystatechange=function(){
                                        console.log('readyState' + xmlhttp.readyState);
                                            ...
                                            if (xmlhttp.status == 200) {
                                                console.log(xmlhttp.responseText);
                                                console.log("OK value = " + parserXML(xmlhttp.responseText,tag));
...
module.exports = {
    foundDevise : function(success,error){
        var listRooms = [];
        var self=this;
        ...
        xmlhttp.open("GET", "http://"+ip+":1400/status/zp", true);
                           ...
                           xmlhttp.onreadystatechange=function(){
                            ...
                            return success(item);
                                  ...
                                  alert('Все huevo, status' + xmlhttp.status + xmlhttp.responseText);
                                  return error('ERROR!');
                         }
                                                       }
                         xmlhttp.send(null);
