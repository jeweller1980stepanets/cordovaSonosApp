...
static const NSString *kXMLReaderTextNodeKey = @"text";
static const NSString *kXMLReaderAttributePrefix = @"@";
...
- (void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName
{
    ...
    if ([_textInProgress length] > 0) {
        ...
        NSString *trimmedString = [_textInProgress stringByTrimmingCharactersInSet:[NSCharacterSet whitespaceAndNewlineCharacterSet]];
